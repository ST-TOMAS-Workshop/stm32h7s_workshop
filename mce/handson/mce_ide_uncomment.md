...
We use similar configuration for MCE but now we allow write. 
Already uncommented
...
- We used MCE to secure our application
- In bootloader we use MCE to decrypt data
- In External loader we used MCE to encypt the data during loading